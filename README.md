...
- По большей части значение зависит от от вашего лора и фразбука, если в них много символов, то и значение нужно большое. (По моим подсчетам для ~20000 символов лора+фразбук нужно ~15000 контекста.
...
### Попробуйте эти значения как у меня, так же прилагаю нагрзка до и псоле запуска сервера (режим дуо: (Qwen-VL-2B + mmproj F16) + Qwen-4B (без VL))
#### Моё железо:
- I7 12700KF
- 32 ГБ ОЗУ
- RTX 4070 Ti Super
