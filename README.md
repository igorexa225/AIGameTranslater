...
#### 2) Там же есть переключатель для соло и даул режима. 
...
<img width="457" height="41" alt="image" src="https://github.com/user-attachments/assets/90dd4046-fe06-410b-91e5-cd273254b1c6" />
...
#### 4) Модели 
- Выберите необходимые модели (Для соло режима только две: VL модель и mmproj модель. Для дуо три: VL модель и mmproj для чтение текста и простая для перевода).
- Соло
...
### ГЛАВНОЕ ЕСЛИ ВЫ МЕНЯЕТЕ ПРОМПТ И ИСПОЛЬЗУЕТЕ ФАЙЛ ЛОРА ИЛИ ФРАЗБУКА ТО В КОНЦЕ ОБЯЗАТЕЛЬНО СДЕЛАЙТЕ ТАК, ИНАЧЕ ЛОР/ФРАЗБУК НЕ СРАБОТАЕТ:
- === LORE START ===
{{LORE}}
=== LORE END ===
