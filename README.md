...
### Советы:
1) Если у вас есть LmStudio, можете использовать модели там, просто вставте IP и порт оттуда и всё заработает. В LmStudio более простая настройка и сразу пишут все ошибки
