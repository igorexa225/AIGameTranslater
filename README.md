...
##### ВНИМАНИЕ: Функции Лора, Фразбука и Памяти диалогов НЕ РАБОТАЮТ в режиме ONLINE. Google Translate переводит каждое предложение отдельно и не умеет запоминать имена персонажей.
