...
Пока что все фишки и оптимизация заточены под английский язык, в будущем добавлю поддержку других языков.
...
#### ВНИМАНИЕ: Функции память диалогов НЕ РАБОТАЮТ в режиме ONLINE. Google Translate переводит каждое предложение отдельно и не умеет запоминать имена персонажей.
...
### ВСЕ ЧТО ИДЕТ ДАЛЬШЕ ВЛИЯЕТ НА ВАШУ ПРОИЗВОДИТЕЛЬНОСТЬ И РАБОТУ ИИ В ЦЕЛОМ, В КОНЦЕ Я ДАМ НЕБОЛЬШУЮ СВОДКУ, ЧТО ЗА ЧТО ОТВЕЧАЕТ КАКОЕ ВЛИЯНИЕ НА ПРОИЗВОДИТЕЛЬНОСТЬ И РАБОТУ ИИ. ДЛЯ ДУО РЕЖИМА ЗНАЧЕНИЯ ДЕЛИТЕ НА 2 ДЛЯ КАЖДОЙ МОДЕЛИ (ИСКЛЮЧЕНИЕМ ЯВЛЯЮТСЯ МАКС.ТОКЕНЫ И КОНТЕКСТ (CTX-SIZE), ЕСЛИ В СОЛО БЫЛО ТОКЕНОВ 1000, ТО ДЛЯ ПЕРЕВОДА ОСТАВЬТЕ 500 И ДЛЯ ГЛЯДЕЛКИ 500. ЗНАЧЕНИЕ КОНТЕКСТА ПЕРЕХОДИТ ПОЛНОСТЬ В ПЕРЕВОДЧИК ТАК КАК ДЛЯ ОБРАБОТКИ ЛОРА И ФРАЗБУКА НУЖНО БОЛЬШЕЕ ЗНАЧЕНИЕ. ДЛЯ ГЛЯДЕЛКИ ОСТАВЬТЕ 1500 ИЛИ 2000 (ЕСЛИ НЕ ХВАТАЕТ)). ОСТАВЬТЕ ПОКА ЗНАЧЕНИЯ ПО УМОЛЧАНИЮ, ЕСЛИ БУДЕТ ПЕЧАЛЬНО ПОНИЖАЙТЕ ИЛИ ПОВЫШАЙТЕ НЕМНОГО КАЖДЫЙ ПАРАМЕТР.
